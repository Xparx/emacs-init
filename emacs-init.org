...
# TODO: There is some issues so you might want to use the =--classic= flag and remove =--NoColor=
#+begin_src emacs-lisp
(when (executable-find "ipython")
  (setq
   python-shell-interpreter "ipython"
   python-shell-interpreter-args "--no-confirm-exit --no-banner --colors=NoColor"
   org-babel-python-command "ipython --no-confirm-exit --no-banner --colors=NoColor"))
#+end_src
