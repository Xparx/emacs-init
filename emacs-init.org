...
**** RefTeX
     ...
     #+begin_src emacs-lisp
       (setq reftex-default-bibliography '("./refs.bib" "~/research/library.bib"))
     #+end_src
...
**** Emacs ipython notebook
     Enables completion in ein buffer. This gives a bit of
     unexpected behaviour. No popup occure even though latest popup.el
     is installed.
     #+begin_src emacs-lisp
...
**** Org-Mode File association
     ...
     Make it so that org-mode opens external pdf files in evince
     #+begin_src emacs-lisp
       (eval-after-load "org"
