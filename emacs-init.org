...
** Emacs init basics
   ...
   - TODO: Only load code if package requirements are met. Does not work as expected right now. ::
        src: [[http://permalink.gmane.org/gmane.emacs.orgmode/75676][here]] and [[https://github.com/fniessen/emacs-leuven/blob/master/emacs-leuven.el][here]],
     #+name: emacs-init-require
     #+begin_src emacs-lisp :tangle no
           ...
           (condition-case err
             ...
             (file-error ;; condition
              (progn
                ...
                (add-to-list 'my--missing-packages feature 'append))
              nil))))
     #+end_src
...
**** Some auctex specific settings.
     Install and sync auctex repository with el-get, do manually
     #+begin_src emacs-lisp :tangle no
       (el-get 'sync '(auctex))
     #+end_src
