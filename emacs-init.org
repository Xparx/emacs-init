     ...
     #+begin_src emacs-lisp
       (defun my-auto-tex-cmd (must-be-here-for-hook-to-work)
         ...
         (cond
          ...
          ( ;; bibtex -> pdf
           (string-match "LATEX_CMD: mkpdfbibtex" (buffer-string))
...
**** Org RefTeX integration with org-ref
     ...
     :CUSTOM_ID: org-ref
     :END:
     Deprecated source: [[http://tincman.wordpress.com/2011/01/04/research-paper-management-with-emacs-org-mode-and-reftex/][here]]
