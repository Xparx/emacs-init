...
Default [[http://ergoemacs.org/emacs/dired_sort.html][format]] of dired
#+begin_src emacs-lisp
...
#+begin_src emacs-lisp
  (setq org-capture-templates
        '(("t" "Todo" entry (file+headline (car org-agenda-files) "Tasks")
          ...
          ("r" "Research task" entry (file+headline "~/research/notes.txt" "Tasks")
           "* TODO %?\n%i\n%a" :kill-buffer t)
          ("R" "Research note" entry (file+headline "~/research/notes.txt" "Notes")
           "* %?\n%U\n%a\n%i" :prepend t :kill-buffer t)
