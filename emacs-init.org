...
Make julia work in org-mode (Not sure if this is included in ess)
#+begin_src emacs-lisp :tangle no
(el-get 'sync '(ob-julia))
#+end_src

Initiate julia mode.
#+begin_src emacs-lisp
;; (when (and (or (el-get-package-exists-p "ess") (el-get-package-exists-p "julia-mode")) (f-exists? (executable-find "julia")))
(when (and (el-get-package-exists-p "ess") (f-exists? (executable-find "julia")))
  (require 'ess-site)
